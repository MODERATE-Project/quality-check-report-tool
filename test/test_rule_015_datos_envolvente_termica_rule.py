...
from rules.rule_015_datos_envolvente_termica_rule import PuentesTermicosRule
...
# Buscar la regla de tipo 'PuentesTermicosRule'
rule_data = next(
...
if not rule_data:
    raise ValueError("No se encontró una regla de tipo 'PuentesTermicosRule' en el JSON de caché.")
